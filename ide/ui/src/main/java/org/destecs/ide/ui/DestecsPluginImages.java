...
public class DestecsPluginImages
{
			...
			String key)
	{
		...
		if (fgImageRegistry != null)
		{
			DestecsUIPlugin.logErrorMessage("Image registry already defined"); //$NON-NLS-1$
		}
		return result;
	}
			...
			boolean useMissingImageDescriptor)
	{
		...
		return createImageDescriptor(DestecsUIPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
	}
