...
//			 final  IContainer  c  =  (IContainer)  selection.getFirstElement();
			 ...
			 fw.write("Revision,Actions,Author,Date,Message,Auto-detected Changes,Exploration Point,Imporatant Change,Baseline\r\n");
	         ...
	         fw.write("3,edit,bnk,10:40:33 March 5 2011,controller2 is changed,,Yes,,\r\n");
	         fw.write(",,,,,> 2 changes in WaterTank (type: CT Mainmodel),,,\r\n");
	         ...
	         System.out.println("Development log file is generated at: C:\\dectecstemp\\Development Log.csv");
