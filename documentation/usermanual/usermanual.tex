...
Development Environment (IDE) version 2.0.0, which enables collaborative
...
dialect of VDM is called VDM Real Time (VDM-RT) which is supported by
...
The Crescendo tool was originally called the DESTECS tool since it was produced in the European research project called DESTECS (see Section~\ref{sec:destecs} below). It supports a method of collaborative modelling and simulation called \emph{co-simulation}. 
...
application, in many cases having been used
...
and store them, you will need a licence (see Section~\ref{sec:install}). In order to install to package of the Crescendo package you need to have:
...
%% Unless you have purchased a licence during model editing and
...
%% to ask Controllab for trial licence.
