<xsl:stylesheet version="1.0"
	...
	<xsl:template name="topLevel">
		...
		<p>
			Interface Version:
			<span class="name">
				<xsl:value-of select="XML-RPC_Library/interfaceVersion/major" />.<xsl:value-of select="XML-RPC_Library/interfaceVersion/minor" />
			</span>
			<br />
			Implementation Version:
			<span class="name">
				<xsl:value-of select="XML-RPC_Library/implementationVersion/major" />.<xsl:value-of select="XML-RPC_Library/implementationVersion/minor" />
			</span>
		</p>
		<p>
			Root name:
			...
			Group name:
			<span class="name">
				<xsl:value-of select="XML-RPC_Library/name" />
			</span>
		</p>
	...
	<xsl:template name="methods">
		...
		<xsl:sort select="methodCall/methodName"/>
			<li><a href="#{methodCall/methodName}"><xsl:value-of select="methodCall/methodName"/></a></li>
		</xsl:for-each>
		</ul>
		</span>
		</p>
...
<h3>Overview</h3>
	...
	<xsl:template name="method" match="method">
		...
		<table class="method" id="{methodCall/methodName}">
			<tr class="header">
