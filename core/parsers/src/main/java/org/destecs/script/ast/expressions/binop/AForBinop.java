...
*
*/
public class AForBinop extends PBinopBase
{
	...
	**/
	...
	if (o != null && o instanceof AForBinop)
	...
	/**
	* Calls the {@link IAnalysis#caseAForBinop(AForBinop)} of the {@link IAnalysis} {@code analysis}.
	* @param analysis the {@link IAnalysis} to which this {@link AForBinop} node is applied
	*/
	@Override
	public void apply(IAnalysis analysis)
	{
		analysis.caseAForBinop(this);
	}


	/**
	* Calls the {@link IAnswer#caseAForBinop(AForBinop)} of the {@link IAnswer} {@code caller}.
	* @param caller the {@link IAnswer} to which this {@link AForBinop} node is applied
	*/
	@Override
	public <A> A apply(IAnswer<A> caller)
	{
		return caller.caseAForBinop(this);
	}


	/**
	* Calls the {@link IQuestion#caseAForBinop(AForBinop, Object)} of the {@link IQuestion} {@code caller}.
	* @param caller the {@link IQuestion} to which this {@link AForBinop} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q> void apply(IQuestion<Q> caller, Q question)
	{
		caller.caseAForBinop(this, question);
	}


	/**
	* Calls the {@link IQuestionAnswer#caseAForBinop(AForBinop, Object)} of the {@link IQuestionAnswer} {@code caller}.
	* @param caller the {@link IQuestionAnswer} to which this {@link AForBinop} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q, A> A apply(IQuestionAnswer<Q, A> caller, Q question)
	{
		return caller.caseAForBinop(this, question);
	}
