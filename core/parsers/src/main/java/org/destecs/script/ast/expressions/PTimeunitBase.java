...
*
*/
public abstract class PTimeunitBase extends Node implements PTimeunit
{
	...
	**/
	 ...
	 * @param child the child node to be removed from this {@link PTimeunitBase} node
	 * @throws RuntimeException if {@code child} is not a child of this {@link PTimeunitBase} node
	 */
