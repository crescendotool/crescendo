...
*
*/
public class AMsTimeunit extends PTimeunitBase
{
	...
	**/
	 ...
	 * @param child the child node to be removed from this {@link AMsTimeunit} node
	 * @throws RuntimeException if {@code child} is not a child of this {@link AMsTimeunit} node
	 */
	 ...
	 * @return a deep clone of this {@link AMsTimeunit} node
	 */
	public AMsTimeunit clone(Map<INode,INode> oldToNewMap)
	{
		AMsTimeunit node = new AMsTimeunit(
		);
	...
	/**
	* Calls the {@link IAnalysis#caseAMsTimeunit(AMsTimeunit)} of the {@link IAnalysis} {@code analysis}.
	...
	*/
	...
	/**
	* Calls the {@link IAnswer#caseAMsTimeunit(AMsTimeunit)} of the {@link IAnswer} {@code caller}.
	...
	*/
	...
	/**
	* Calls the {@link IQuestion#caseAMsTimeunit(AMsTimeunit, Object)} of the {@link IQuestion} {@code caller}.
	* @param caller the {@link IQuestion} to which this {@link AMsTimeunit} node is applied
	...
	*/
	...
	/**
	* Calls the {@link IQuestionAnswer#caseAMsTimeunit(AMsTimeunit, Object)} of the {@link IQuestionAnswer} {@code caller}.
	* @param caller the {@link IQuestionAnswer} to which this {@link AMsTimeunit} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
